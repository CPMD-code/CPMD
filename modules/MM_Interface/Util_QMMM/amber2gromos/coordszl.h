C $Id: coordszl.h,v 1.1 2006-12-27 11:19:15 itavern Exp $ -*-fortran-*-
...
C     maximum number of distance constraints PER SOLUTE MOLECULE
      INTEGER MAXCON
C     PARAMETER (MAXCON = 3200)
      PARAMETER (MAXCON = 6000)
COMMEND
...
C
      INTEGER MXDMON
C     PARAMETER (MXDMON  = 2500)
      PARAMETER (MXDMON  = 5000)
COMMEND
